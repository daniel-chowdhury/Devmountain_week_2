...
function bestMovie(moviename) {
  return `${moviename} is the best movie ever`
}

console.log(bestMovie("Don't look up"))
...
arrayEvaluator = bigOrSmall([122, 56, 555, 4])
...
console.log(emailCheck("daniel@gmail.com"))
...
//CODE HERE
function choc_frog(input) {
  let myfrogs = input/3;
  return myfrogs
}

let totalFrogs = choc_frog(4)
...
//CODE HERE
function choc_frog2(input) {
  let remainder = input%3;
  input = input - remainder;
  let myfrogs = input/3
  return myfrogs
}
let totalFrogs2 = choc_frog2(10)
...
//CODE HERE
function isascending(input_array) {
